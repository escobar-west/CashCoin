...
class Transaction extends Resource
{
    ...
    public function setEthereumAmount($amount)
    {
        $this->amount = new Money($amount, CurrencyCode::ETH);
    }
    ...
    public function setToEthereumAddress($address)
    {
        $this->to = new EthereumAddress($address);
    }
