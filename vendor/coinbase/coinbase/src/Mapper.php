...
class Mapper
{
    ...
    public function fromTransaction(Transaction $transaction)
    {
        ...
        if ($to && !$to instanceof Email && !$to instanceof BitcoinAddress && !$to instanceof EthereumAddress && !$to instanceof Account) {
            throw new LogicException(
                'The Coinbase API only accepts transactions to an account, email, ethereum, or bitcoin address'
            );
        }
